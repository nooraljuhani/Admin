...
<div class="form">
<form class="cmxform form-horizontal style-form" id="signupForm" action="oopadmin.php" method="post">
...
<?php
 ...
 echo "<td><a href='oopedit.php?id={$row['Admin_ID']}' class='btn btn-primary'>Edit</a></td>";
 echo "<td><a href='oopdelete_admin.php?id={$row['Admin_ID']}' class='btn btn-danger'>Delete</a></td>";
echo "</tr>";
}?>
                </tbody>
              </table>
